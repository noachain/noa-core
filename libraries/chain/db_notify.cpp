...
struct get_impacted_account_visitor
{
   ...
   void operator() (const poker_asset_create_operation& op ) {}
   ...
   void operator() (const data_product_create_operation& op )
   {
       _impacted.insert(op.requester);
   }
   void operator() (const data_product_update_operation& op )
   {
       _impacted.insert(op.new_requester);
   }

   void operator ()(const model_product_create_operation&op)
   {
       _impacted.insert(op.requester);
   }

   void operator ()(const model_product_update_operation&op)
   {
        _impacted.insert(op.new_requester);
   }

   void operator() (const power_product_create_operation&op)
   {
       _impacted.insert(op.requester);
   }

   void operator ()(const power_product_update_operation&op)
   {
       _impacted.insert(op.new_requester);
   }
};
      ...
      switch( (object_type)obj->id.type() )
      {
        ...
        case account_object_type:{
          ...
          break;
           ...
           break;
        }case data_product_object_type:{
          break;
        }case data_product_complain_object_type:{
          break;
        }case model_product_object_type:{
         break;
        }case model_product_complain_object_type:{
         break;
        }case power_product_object_type:{
         break;
        }case power_product_complain_object_type:{
         break;
        }
      }
   }
   else if( obj->id.space() == implementation_ids )
   {
      switch( (impl_object_type)obj->id.type() )
      {
             ...
             case impl_fba_accumulator_object_type:
              break;
             case impl_data_product_search_result_object_type:
              break;
             case impl_model_product_search_result_object_type:
              break;
             case impl_power_product_search_result_object_type:
              break;
